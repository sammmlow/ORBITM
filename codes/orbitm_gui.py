...
class run_gui:
    ...
    def __init__(self, master):
        ...
        self.entry00b = tk.Radiobutton(master, text='STK',
                                       variable=self.var00, value=2)
        self.entry00b.grid(row=1, column=2, padx=5, pady=2, sticky='w')
        self.entry00c = tk.Radiobutton(master, text='GMAT (Unavailable)',
        ...
        self.errtx01.grid(row=2, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx02.grid(row=3, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx03.grid(row=4, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx04.grid(row=5, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx05.grid(row=6, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx06.grid(row=7, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx07.grid(row=8, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx08.grid(row=9, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx09.grid(row=10, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx10.grid(row=11, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx11.grid(row=12, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx12.grid(row=13, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx13.grid(row=14, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx14.grid(row=15, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx15.grid(row=16, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx16.grid(row=17, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx17.grid(row=18, column=4, padx=5, pady=2, sticky='w')
        ...
        self.errtx18.grid(row=19, column=4, padx=5, pady=2, sticky='w')
    ...
    def cfg_R(self):
        ...
        if inps['orbsim'] == 1:
            ...
            self.errtx00.configure(text='Invalid! Choose programs 1, 2, or 3!')
    ...
    def cfg_W(self):
        ...
        var_arr = [self.var00, self.var01, self.var02, self.var03, self.var04,
                   ...
                   self.var15, self.var16, self.var17, self.var18]
    ...
    def run(self):
        ...
        self.cfg_W() # Write and save to config file before running
