...
# User, input your desired mission duration length in days
# Do not put date times beyond the present moment, somehow it throws errors.
tstart = '1 Jan 2012 12:00:00.000'
tfinal = '1 Jan 2015 12:00:00.000'

# User, put your spacecraft-related inputs here.
sc_Cd     = 2.3 # unit-less drag coefficient
sc_Ck     = 1.0 # albedo coefficient
sc_Cr     = 1.0 # radiation pressure coefficient
sc_mass   = 170.0 # dry mass (kg)
sc_area_d = 2.5 # drag surface area normal (m^2)
sc_area_r = 1.0 # solar rad surface area normal (m^2)
sc_area_a = 1.0 # albedo surface area normal (m^2)

# User, input your orbit (initial osculating) parameters here.
orb_a = 6934.63 # semi-major axis(km)
orb_e = 0.00143075 # eccentricity
orb_i = 10.0 # inclination (deg)
orb_R = 180.0 # raan (deg)
orb_w = 90.0 # argument of perigee (deg)
orb_m = 45.0 # mean anomaly (deg)

# User, input your thruster parameters, using an along-track direction thrust
...
# User, input your orbit maintenance tolerance band and maintenance strategy
maintenance_tolerance = 0.5 # tolerance band (km) before firing thrusters
maintenance_margin    = 1.0 # margin of safety, 1.0 = 100%
maintenance_fro       = True # True -> frozen repeat; false -> normal

# For thruster sizing and plotting, what range of Isp and fuel mass is needed?
plot_Isp_Min = 100.0 # N s
plot_Isp_Max = 2000.0 # N s

# User, check this below if you want the STK GUI to open up too (default False)
stk_gui = True
